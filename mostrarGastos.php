...
<?php  
    ...
    $gtosConserjeMen = mostrarConserjeMen();
    include 'funciones/gastosGeneralesMen.php';
    $gtosGeneralesMen = mostrarGtosGenMen();
    include 'funciones/gastosAdmMen.php';
    $gtosAdmMen = mostrarGtosAdmMen();
    include 'funciones/gastosParticularesMen.php';
    $gtosParticularesMen = mostrarGtosParMen();
    include 'funciones/gastosEspecialesMen.php';
    $gtosEspecialesMen = mostrarGtosEspeMen();
...
?>
    ...
    <main class="container">
    <h1>                    Cuota Especial Mensual</h1>

      <table class="table table-bordered table-stripped table-hover">
        <thead class="thead-dark">
        <tr>
            <th>Cod. Gasto</th>
            <th>Descripción de Cuota Especial </th>
        ...
        <tbody>
<?php
    while( $esp = mysqli_fetch_assoc($gtosEspecialesMen) ){
?>
        <tr>
