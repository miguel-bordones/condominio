...
$SQL_READ =  "select * from gastos_conserje_mensual";
$SQL_READ2 = "select * from gastos_general_mensual";
$SQL_READ3 = "select * from gastos_admin_mensual";
$SQL_READ4 = "select * from gastos_particulares_mensual";
