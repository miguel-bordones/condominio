...
WHERE RECI_CD_EDIFICIO = 1 AND
        ...
        while($movrecibo = mysqli_fetch_assoc($recibos))
     {
       if($conta == 0)
       {
          if($mes==1)
          {
               ...
               SET 
                 SA_MT_ENERO        = 'TO_NUMBER($movrecibo[MT_RECIBO]'
                WHERE SA_CD_EDIFICIO = 1 AND
                 SA_NU_TORRE    = 1 AND 
        ...
        if($conta == 1)
         {
          ...
          (SA_CD_EDIFICIO,
           ...
           ('1',
            ...
            '$year',
            '0',
            IF('$mes'='1','TO_NUMBER($movrecibo[MT_RECIBO]','999999999D99')','0'),
            IF('$mes'='2','TO_NUMBER($movrecibo[MT_RECIBO]','999999999D99')','0'),
            IF('$mes'='3','TO_NUMBER($movrecibo[MT_RECIBO]','999999999D99')','0'),
            IF('$mes'='4','TO_NUMBER($movrecibo[MT_RECIBO]','999999999D99')','0'),
            IF('$mes'='5','TO_NUMBER($movrecibo[MT_RECIBO]','999999999D99')','0'),
            IF('$mes'='6','TO_NUMBER($movrecibo[MT_RECIBO]','999999999D99')','0'),
            IF('$mes'='7','TO_NUMBER($movrecibo[MT_RECIBO]','999999999D99')','0'),
            IF('$mes'='8','TO_NUMBER($movrecibo[MT_RECIBO]','999999999D99')','0'),
            IF('$mes'='9','TO_NUMBER($movrecibo[MT_RECIBO]','999999999D99')','0'),
            IF('$mes'='10','TO_NUMBER($movrecibo[MT_RECIBO]','999999999D99')','0'),
            IF('$mes'='11','TO_NUMBER($movrecibo[MT_RECIBO]','999999999D99')','0'),
            IF('$mes'='12','TO_NUMBER($movrecibo[MT_RECIBO]','999999999D99')','0'));";
   ...
   WHERE GADM_CD_EDIFICIO = 1 AND
      ...
      $fecha_proc = $mto_reserva['GADM_FE_GASTO'];
   ...
   WHERE GADM_CD_EDIFICIO = 1 AND
      ...
      $sql_upd = "UPDATE  edificio
        ...
        $sql_inse_s = "INSERT INTO  saldos_edificio
        (SAED_CD_EDIFICIO,
        SAED_MT_PRESTACIONES, 
        SAED_MT_RESERVA, 
        ...
        0,
        '".$fecha_proc."');";
         $sql_inse_saldos  = mysqli_query($link,$sql_inse_s)  or die( mysqli_error($link));
