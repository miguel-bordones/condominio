...
?>
    ...
    <main class="container">
        <h1>Eliminar Gasto Administrativo</h1>

        <div class="alert bg-light p-4 col-6 mx-auto border border-danger shadow-sm">
            <div class="row">
        
                <div class="col text-danger">
                    <h2> Codigo de Gasto: <?=  $gasto['GAMI_CD_GASTO']   ?></h2>
                         Desc. Gasto :    <?=  $gasto['GAMI_DESC_GASTO'] ?><br>
                   

                    <form action="eliminarGastosAdm.php" method="post">
                        <input type="hidden" name="GAMI_CD_GASTO"
                               value="<?= $gasto['GAMI_CD_GASTO'] ?>">
