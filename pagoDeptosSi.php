...
?>
            <tr>
            <td><?= $row['SA_CD_EDIFICIO']?></td>
            <td><?= $row['SA_NU_TORRE']?></td>
            <td><?= $row['SA_DEPTO']?></td>
            ...
            <td>
       <a href="formModificarPagos.php?SA_DEPTO=<?php echo $row['SA_DEPTO']?>&year=<?php echo $yeare;?>" class="btn btn-outline-secondary">
                    Actualizar
                </a>
             </td>
           </tr>
